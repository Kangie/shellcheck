...
portageInternalVariables = [
    ...
    "BAZEL_CC_CONFIG_DIR", "BAZEL_CC_TOOLCHAIN", "BAZEL_PORTAGE_PACKAGE_DIR",
    ...
    -- dlc.eclass
    "DLC_ARTIFACT_DIR", "DLC_FS_TYPE", "DLC_ID", "DLC_NAME", "DLC_PACKAGE",
    "DLC_PREALLOC_BLOCKS", "DLC_PRELOAD", "DLC_VERSION",
    ...
    "EGIT_QUIET", "EGIT_UNPACK_DIR", "EGIT_UPDATE_CMD",
    "LIVE_FAIL_FETCH_IF_REPO_NOT_UPDATED",
    ...
    -- platform.eclass
    "PLATFORM_ARC_BUILD", "PLATFORM_GYP_FILE", "PLATFORM_NATIVE_TEST",
