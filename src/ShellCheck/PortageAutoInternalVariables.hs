...
portageAutoInternalVariables =
    ...
    ("arc-camera", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG",
    "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "PACKAGE"]),
    ...
    ("boost-utils", ["BOOST_MAX_SLOT", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE"]),
    ...
    ("cargo", ["CARGO_INSTALL_PATH", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE"]),
    ...
    ("cros-camera", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),

    ("cros-common.mk", ["CROS_COMMON_MK_NATIVE_TEST", "EPATCH_COMMON_OPTS",
    "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS",
    "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE",
    "EVCS_OFFLINE", "UNIBOARD_CROS_CONFIG_DIR", "UNIBOARD_C_CONFIG",
    "UNIBOARD_JSON_INSTALL_PATH", "UNIBOARD_YAML_CONFIG", "UNIBOARD_YAML_DIR"]),
    ...
    ("cros-fwupd", ["CROS_FWUPD_URL", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE"]),
    ...
    "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG",
    "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "ISH_TARGETS",
    "UNIBOARD_CROS_CONFIG_DIR", "UNIBOARD_C_CONFIG",
    "UNIBOARD_JSON_INSTALL_PATH", "UNIBOARD_YAML_CONFIG", "UNIBOARD_YAML_DIR"]),

    ("cros-kernel-info", ["CONFIG_CHECK", "EPATCH_COMMON_OPTS",
    "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS",
    "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "KBUILD_OUTPUT", "KERNEL_DIR",
    "KV_DIR", "KV_EXTRA", "KV_FULL", "KV_LOCAL", "KV_MAJOR", "KV_MINOR",
    "KV_OUT_DIR", "KV_PATCH", "_LINUX_CONFIG_EXISTS_DONE"]),

    ("cros-kernel2", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),

    ("cros-llvm", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    "APACHE_VHOSTS_CONFDIR", "APXS", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE"]),
    ...
    "CHROMITE_BIN_DIR", "CHROMITE_DIR", "CHROOT_SOURCE_ROOT",
    "CROS_GIT_AOSP_URL", "CROS_GIT_HOST_URL", "CROS_GIT_INT_HOST_URL",
    "DLC_DAYS_TO_PURGE", "DLC_DESCRIPTION", "DLC_ENABLED", "DLC_FS_TYPE",
    "DLC_ID", "DLC_MOUNT_FILE_REQUIRED", "DLC_NAME", "DLC_PACKAGE",
    "DLC_PREALLOC_BLOCKS", "DLC_PRELOAD", "DLC_USED_BY", "DLC_VERSION"]),
    ...
    ("fortran-2", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE",
    ...
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "G2CONF",
    "GCONF_DEBUG", "GNOME2_EAUTORECONF", "GNOME2_ECLASS_GIO_MODULES",
    "GNOME2_LA_PUNT", "HTML_DOCS", "PATCHES", "WANT_AUTOCONF", "WANT_AUTOMAKE",
    ...
    ("gpe", ["ELTCONF", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "GPE_DOCS"]),
    ...
    ("intel-sdp", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "INTEL_ARCH",
    "INTEL_BIN_RPMS", "INTEL_DAT_RPMS", "INTEL_DID", "INTEL_DPN", "INTEL_DPV",
    "INTEL_RPMS_DIRS", "INTEL_SDP_DB", "INTEL_SDP_DIR", "INTEL_SDP_EDIR",
    "INTEL_SUBDIR", "INTEL_X86"]),
    ...
    ("java-vm-2", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "EPREFIX",
    "JAVA_VM_BUILD_ONLY", "JAVA_VM_CONFIG_DIR", "JAVA_VM_DIR",
    "JAVA_VM_SYSTEM"]),
    ...
    ("libtool", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),

    ("linux-info", ["CONFIG_CHECK", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE", "KBUILD_OUTPUT", "KERNEL_DIR", "KV_DIR", "KV_EXTRA",
    ...
    ("meson", ["BUILD_DIR", "EMESON_SOURCE", "EPATCH_COMMON_OPTS",
    "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS",
    "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "EPYTHON", "MYMESONARGS",
    "NINJAOPTS", "PYTHON", "PYTHON_COMPAT_NO_STRICT", "_PYTHON_ALL_IMPLS",
    "emesonargs", "emesontestargs"]),

    ("meson-multilib", ["BUILD_DIR", "EMESON_SOURCE", "EPATCH_COMMON_OPTS",
    "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS",
    "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    ...
    ("mono", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("multilib", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("myspell", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("mysql-multilib-r1", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE", "MYSQL_CMAKE_EXTRA_DEFINES",
    ...
    ("mysql_fx", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),

    ("mythtv-plugins", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("php-ezc", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE",
    "EZC_BASE_MIN", "EZC_PV", "PEAR_PV", "PHP_PEAR_PKG_NAME"]),

    ("php-lib-r1", ["DOCS", "PHP_LIB_NAME"]),

    ("php-pear", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "PEAR_PV",
    "PHP_PEAR_PKG_NAME"]),

    ("php-pear-r1", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "PEAR_PV",
    "PHP_PEAR_PKG_NAME"]),
    ...
    ("ruby-gnome2", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("ruby-ng-gnome2", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE",
    ...
    ("systemd", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("toolchain-funcs", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("udev", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),

    ("unpacker", ["UNPACKER_BZ2"]),

    ("usr-ldscript", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE"]),
    ...
    ("waf-utils", ["EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE",
    "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE",
    "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE",
