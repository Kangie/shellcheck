...
portageAutoInternalVariables =
    ...
    ("arc-android-installer", ["ARC_ANDROID_INSTALLER_ENV_LIST",
    "ARC_ANDROID_INSTALLER_USE_LIST", "ARC_ANDROID_INSTALLER_VERSION"]),
    ...
    "CROS_RUST_REMOVE_DEV_DEPS", "CROS_RUST_SUBDIR", "CROS_RUST_TESTS",
    "CROS_RUST_TEST_DIRECT_EXEC_ONLY", "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE",
    "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS", "EPATCH_SINGLE_MSG",
    "EPATCH_SOURCE", "EPATCH_SUFFIX", "EPATCH_USER_EXCLUDE",
    "EPATCH_USER_SOURCE"]),
    ...
    "EPATCH_COMMON_OPTS", "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG",
    "EPATCH_OPTS", "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "EVCS_OFFLINE", "NINJAOPTS",
    ...
    "AT_SYS_M4DIR", "AUTOTOOLS_AUTO_DEPEND", "DOCS", "ELTCONF", "G2CONF",
    "GCONF_DEBUG", "GNOME2_EAUTORECONF", "GNOME2_ECLASS_GIO_MODULES",
    ...
    "EPATCH_EXCLUDE", "EPATCH_FORCE", "EPATCH_MULTI_MSG", "EPATCH_OPTS",
    "EPATCH_SINGLE_MSG", "EPATCH_SOURCE", "EPATCH_SUFFIX",
    "EPATCH_USER_EXCLUDE", "EPATCH_USER_SOURCE", "EPYTHON", "NINJAOPTS",
    "PYTHON", "PYTHON_COMPAT_NO_STRICT", "_PYTHON_ALL_IMPLS", "emesonargs",
    "emesontestargs"]),
    ...
    "CROS_GO_TEST", "CROS_GO_VERSION", "CROS_GO_VET", "CROS_GO_VET_FLAGS",
    "CROS_GO_WORKSPACE", "TAST_BUNDLE_EXCLUDE_DATA_FILES", "TAST_BUNDLE_PRIVATE"]),
